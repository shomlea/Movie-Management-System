...
public class TechnicalOperatorService {
    @Autowired
    TechnicalOperatorRepositoryInFile technicalOperatorRepository;
    ...
    public boolean update(String id, String name, double salary, Specialization specialization) {
        TechnicalOperator technicalOperator = new TechnicalOperator(id, name, salary, specialization);
        return technicalOperatorRepository.update(id, technicalOperator);
    }
